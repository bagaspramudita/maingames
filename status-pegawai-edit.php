                                        ...
                                        <form action="lib/<?= strtolower($slug); ?>-<?= strtolower($nav1); ?>-aksi.php" class="form-horizontal" method="POST">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        <label class="control-label col-md-5">Status Pegawai</label>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <!-- EDIT ID -->
                                                        <input type="hidden" name="id" value="<?= $tampil['status_id']; ?>">
                                                        <!-- EDIT ID -->
                                                        <input type="text" name="status_pegawai" value="<?= $tampil['status_pegawai']; ?>" required="required" class="form-control">        
                                                    </div>
