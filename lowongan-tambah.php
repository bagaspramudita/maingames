                                        ...
                                        <form action="lib/<?= strtolower($page); ?>-<?= strtolower($nav1); ?>-aksi.php" class="form-horizontal" method="POST">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" placeholder="Masukan Lowongan..." name="lowongan" required="required" class="form-control">        
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <textarea placeholder="Deskripsi Lowongan..." cols="30" rows="4" name="deskripsi" class="form-control" required></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="input-group">
                                                            <input onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="2" type="text" class="form-control" placeholder="Jumlah" name="qty">
